...
export const COMMANDS = {
    ...
    ANALYZE_VIEW_PERFORMANCE: 'flint.perspective.analyzeView',
    PROFILE_VIEW_PERFORMANCE: 'flint.perspective.profileView',
    PROFILE_PAGE: 'flint.perspective.profilePage',

    // Tag Browser commands
    TAG_READ_VALUE: 'flint.readTagValue',
    TAG_WRITE_VALUE: 'flint.writeTagValue',
    TAG_GET_CONFIG: 'flint.getTagConfig',
    TAG_CREATE: 'flint.createTag',
    TAG_DELETE: 'flint.deleteTag',
    TAG_COPY_PATH: 'flint.copyTagPath',
    TAG_REFRESH: 'flint.refreshTagBrowser'
} as const;
...
export const COMMAND_TITLES = {
    ...
    [COMMANDS.ANALYZE_VIEW_PERFORMANCE]: 'Analyze View Performance',
    [COMMANDS.PROFILE_VIEW_PERFORMANCE]: 'Profile View Performance',
    [COMMANDS.PROFILE_PAGE]: 'Profile Page Bindings',

    [COMMANDS.TAG_READ_VALUE]: 'Read Tag Value',
    [COMMANDS.TAG_WRITE_VALUE]: 'Write Tag Value',
    [COMMANDS.TAG_GET_CONFIG]: 'Get Tag Configuration',
    [COMMANDS.TAG_CREATE]: 'Create Tag',
    [COMMANDS.TAG_DELETE]: 'Delete Tag',
    [COMMANDS.TAG_COPY_PATH]: 'Copy Tag Path',
    [COMMANDS.TAG_REFRESH]: 'Refresh Tag Browser'
} as const;
